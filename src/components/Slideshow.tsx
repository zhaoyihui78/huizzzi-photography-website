      ...
      {isOpen && (
        ...
        >
          ...
          <motion.div
            ...
            className="absolute top-0 left-0 right-0 flex items-center justify-between px-4 py-4 md:px-8 md:py-6 z-20"
          >
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className={`font-mono text-[9px] tracking-[0.2em] uppercase transition-colors duration-300 cursor-pointer ${
                  autoPlay ? 'text-[#c9a96e]' : 'text-white/20 hover:text-white/60'
                }`}
              >
