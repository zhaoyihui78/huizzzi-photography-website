...
export const seriesList: Series[] = [
  ...
  },
  {
    ...
    videos: [
      ...
      { src: getVideoUrl('圆明园的秋', '/works/videos/yuanmingyuande/圆明园.mp4'), poster: getImageUrl('/works/videos/yuanmingyuande/poster.jpg'), title: '圆明园的秋', season: '秋', month: '十一月', subtitle: '金黄圆明园' },
